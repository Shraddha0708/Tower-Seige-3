...
if(backgroundIMG)
 ...
 // strokeWeight(18);
  ...
  block8.Displayscore();
  block9.Displayscore();
  bolck10.Displayscore();
  block11.Displayscore();
  block12.Displayscore();
  block13.Displayscore();
  block14.Displayscore();
  block15.Displayscore();
  block16.Displayscore();
  block17.Displayscore();
  block18.Displayscore();
  block19.Displayscore();
  block20.Displayscore();
  block21.Displayscore();
  block22.Displayscore();
...
async function getBackground() {
  ...
  var daytime = answerJSON.datetime;
